...
CAPTURE_INTERVAL_SEC = 6 # NOTE: Setting this to 0 will cause a high-CPU busy-loop and spam the API.
        ...
        while not self.stop_event.is_set():
            ...
            try:
                ...
                if ai_response:
                    ...
                    # We send the RAW response to add_chat_message because
                    # it has logic to parse both good and bad lines for display.
                    ...
                    # This is the fix. We prevent "history poisoning" by
                    ...
                    if not is_system:
                        ...
                        for line in ai_response.strip().split('\n'):
                            ...
                            # and are not bullet points or the "breakdown" text.
                            if ":" in line and not line.startswith("*") and not line.startswith("Here's"):
                    ...
                    # 5. Add the *text-only* user prompt and the *CLEANED* AI
