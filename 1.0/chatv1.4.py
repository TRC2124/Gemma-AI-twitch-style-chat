...
OLLAMA_MODEL = "gemma3:12b"  # gemma3:12b ; gemma3:4b
...
# --- NEW: Pre-compiled regex for cleaning output ---
# This will find the *first* valid "username: message" pattern in a line,
# even if it's surrounded by junk like "* **" or "..."
CHAT_LINE_REGEX = re.compile(r"([A-Za-z0-9_\-]+):\s+(.+)")
