...
PRESERVE_RESPONSES = 2    # How many last AI messages to keep
...
Behavior & Tone: Messages must simulate a realistic chat environment, including:
    ...
    Variety: Ensure the 3-5 messages come from different perspectives and users (e.g., one could be asking a question, another spamming a single emoji, and a third offering a serious comment).
                ...
                if ai_response:
                    ...
                    if not is_system:
                        ...
                        for line in ai_response.strip().split('\n'):
                            ...
                            if re.match(r"^[A-Za-z0-9_\-]+:\s+.+", line):
                                ...
                                print(f"Filtered malformed line: {line}")
                        cleaned_ai_response_for_history = "\n".join(cleaned_lines)
                    else:
                    ...
                    if cleaned_ai_response_for_history:
                        ...
                        if self.response_count >= RESET_INTERVAL:
                            ...
                            preserved_context = [
                                m for m in list(self.messages_history)
